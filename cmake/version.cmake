...
function(x_NAME_x_set_project_version_from_git_tag)
    ...
    if(NOT _git_branch_result EQUAL 0)
        message(WARNINGS "Failed to run 'git branch'. Branch in project version will be wrong.")
    ...
    message(STATUS "[x_NAME_x] Project version configured from git: ${cleaned_tag}")
...
function(x_NAME_x_add_version_info target)
    ...
    message(STATUS "[x_NAME_x] Prefix of autogenerated version info functions: ${VERSION_PREFIX}")
